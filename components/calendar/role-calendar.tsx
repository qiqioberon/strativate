...
export function RoleCalendar({ role, onOpenAvailability }: { role: Role; onOpenAvailability?: () => void }) {
  ...
  return <div className="native-calendar">
    <div className="role-page-title">
      ...
      <p>{role === 'admin' ? 'Pantau seluruh sesi Strativate, Zoom, dan sinkronisasi Google Calendar tanpa membuka detail kalender pribadi mentor atau mentee.' : 'Gabungkan sesi Strativate dengan agenda Google Calendar pribadi Anda. Zoom adalah provider meeting mentoring; Google Calendar hanya dipakai untuk agenda dan sinkronisasi.'}</p>
    </div>
