  ...
  return (
    <main className="stakeholder-homepage">
      <section className="marketing-hero marketing-hero--revised" data-reveal data-testid="homepage-hero-section">
        ...
        <div className="marketing-container marketing-social-proof" aria-label="Strativate reach">
      ...
      <section className="marketing-section stakeholder-section stakeholder-section--who" aria-labelledby="who-we-are-heading" data-reveal data-testid="homepage-who-we-are-section">
        <div className="marketing-container stakeholder-split"><div><p className="marketing-kicker">Who We Are</p><h2 id="who-we-are-heading">Where Future-Ready Skills Meet Competition Success</h2></div><div><p>Strativate is a learning platform that helps students build practical business skills, sharpen their analytical thinking, and prepare for competitions with expert guidance.</p><p>Our community has supported <strong>2,500+ students</strong> across <strong>15+ universities</strong> and <strong>20+ high schools</strong>.</p><Link className="marketing-text-link" href="/tentang-kami">Learn about Strativate <ArrowRight aria-hidden="true" size={16} /></Link></div></div>
      </section>
      ...
      <section className="marketing-section stakeholder-section stakeholder-products marketing-product-library" aria-labelledby="digital-products-heading" data-reveal data-testid="homepage-products-section">
        <div className="marketing-container stakeholder-product-grid marketing-product-library__grid"><div className="marketing-product-library__copy"><p className="marketing-kicker">Digital Products</p><h2 id="digital-products-heading">Learn beyond the session.</h2><p className="stakeholder-section__lede">Practical resources and learning materials to help you continue building your skills at your own pace.</p><Link className={cn(buttonVariants({ variant: 'primary', size: 'marketing' }), 'marketing-product-library__cta')} href="/produk-digital" data-testid="homepage-products-cta">Explore Digital Products <ArrowRight aria-hidden="true" size={16} /></Link></div>{digitalProductsEnabled && digitalProducts.length ? <DigitalProductCardSwap products={digitalProducts} /> : <div className="stakeholder-empty-state"><strong>Digital products are coming soon.</strong><span>Product details will appear after final approval.</span></div>}</div>
      </section>
      ...
      <section className="marketing-section stakeholder-section stakeholder-partners" aria-labelledby="partners-heading" data-reveal data-testid="homepage-partners-section"><div className="marketing-container"><div className="marketing-section-head is-wide"><div><p className="marketing-kicker">Our Partners</p><h2 id="partners-heading">Partnered with Leading Organizations</h2></div><p className="marketing-section-head__copy">Partner information will appear here as approved logos and collaboration details become available.</p></div><div className="stakeholder-empty-state stakeholder-empty-state--wide"><strong>Partner showcase coming soon.</strong><span>We will publish approved partner identities and stories when the assets are ready.</span></div></div></section>
