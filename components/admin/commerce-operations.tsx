  ...
  const visibleOrders = useMemo(() => {
    ...
    return [...orders].sort((a, b) => {
      ...
      const value = (order: AdminCommerceOrder) => {
        ...
        if (sortKey === 'order_status') return statusLabel(order.order_status)
        return statusLabel(order.payment?.status ?? order.order_status)
      }
