...
type Draft = { name:string; slug:string; description:string; price:string; contentType:DigitalProductContentType|''; isPublished:boolean; homepageFeatured:boolean; homepageOrder:string; showSalesCount:boolean }
const emptyDraft: Draft = { name: '', slug: '', description: '', price: '', contentType: '', isPublished: false, homepageFeatured: false, homepageOrder: '0', showSalesCount: false }
