...
export type Order = { id:string; user_id:string; cart_id:string; status:OrderStatus; currency_code:"IDR"; discount_code_id:string|null; subtotal_amount:number; discount_amount:number; discount_code_snapshot:string|null; total_amount:number; invoice_number?:string|null; created_at:string; updated_at:string; paid_at:string|null }
