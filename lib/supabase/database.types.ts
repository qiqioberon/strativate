...
export type MarketingTestimonial = { id:string; slug:string; competition_name:string; achievement:string; testimonial:string; image_path:string|null; original_image_path:string|null; sort_order:number; is_published:boolean; created_at:string; updated_at:string }
