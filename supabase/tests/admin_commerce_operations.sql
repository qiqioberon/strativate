...
select test_admin_commerce.assert(
  (select owned_by_mentee from public.list_admin_cart_link_items('99000000-0000-0000-0000-000000000002','Ops Test Guide') where commerce_item_id='99010000-0000-0000-0000-000000000001'),
  'owned digital product remains visible but is marked owned'
);
select test_admin_commerce.denied($q$select public.create_commerce_cart_link(
  '99000000-0000-0000-0000-000000000002',
  repeat('a', 64),
  array['99010000-0000-0000-0000-000000000001'::uuid]
)$q$, 'server rejects an already-owned digital product in Cart Link');
