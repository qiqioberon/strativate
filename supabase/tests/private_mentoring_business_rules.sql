...
select '99300000-0000-0000-0000-000000000001',p.id,'private_mentoring','Private 3','private-3',p.price_amount from public.private_mentoring_packages p join public.mentor_tiers t on t.id=p.mentor_tier_id where t.code='TOP_STUDENT' and p.session_count=3
union all
select '99300000-0000-0000-0000-000000000001',p.id,'private_mentoring','Private 5','private-5',p.price_amount from public.private_mentoring_packages p join public.mentor_tiers t on t.id=p.mentor_tier_id where t.code='TOP_STUDENT' and p.session_count=5
union all
select '99300000-0000-0000-0000-000000000001',p.id,'intensive_mentoring_package',p.name,p.slug,p.price_amount from public.intensive_mentoring_packages p where p.pricing_mode='fixed' and p.is_active order by 5 limit 1;
...
insert into public.order_items(order_id,commerce_item_id,item_kind_snapshot,name_snapshot,slug_snapshot,unit_price_amount)
select '99300000-0000-0000-0000-000000000002',p.id,'private_mentoring','Private 3 repeat','private-3-repeat',p.price_amount from public.private_mentoring_packages p join public.mentor_tiers t on t.id=p.mentor_tier_id where t.code='TOP_STUDENT' and p.session_count=3;
