...
export default function ExplorePage() {
  ...
  return <main className="catalog-page">
    <header className="catalog-hero"><div><p className="kicker">STRATIVATE / JELAJAHI PROGRAM</p><h1>Ambil langkah berikutnya<br /><em>dengan terarah.</em></h1><p className="catalog-lede">Program, mentoring, kelas kelompok, dan perangkat belajar untuk mengubah ambisi menjadi rencana yang dapat kamu jalankan.</p></div><div className="catalog-hero-note"><span>04</span><p>cara belajar<br />bersama Strativate</p></div></header>
