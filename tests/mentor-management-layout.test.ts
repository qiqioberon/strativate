...
test('mentor accounts render as a sortable semantic data table with the real management columns', () => {
  ...
  assert.match(management, /SortableTableHeader label="Mentor"/)
  assert.match(management, /SortableTableHeader label="Tier"/)
  assert.match(management, /SortableTableHeader label="Status akun"/)
  assert.match(management, /SortableTableHeader label="Setup akun"/)
  assert.match(management, /SortableTableHeader label="Ketersediaan"/)
...
test('mentor invitation flow, sortable headers, and reload remain reachable', () => {
  const management = readFileSync(managementPath, 'utf8')
  ...
  assert.match(invitations, /SortableTableHeader label="Email"/)
